...
>
	...
	<a href="/" data-wpel-link="internal"><span>Home</span></a>
	...
	<a href="/" data-wpel-link="internal"><span>Home</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<a href="/sitemap.xml" data-wpel-link="internal"><span>Sitemap Index</span></a>
						<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
				...
				<xsl:for-each select="sitemap:urlset/sitemap:url">
						...
						<td class="left">
							...
							<xsl:choose>
								<xsl:when test="count(./*[@rel='alternate']) > 0">
									<xsl:for-each select="./*[@rel='alternate']">
										<xsl:if test="position() = last()">
											<a href="{current()/@href}" class="localized" data-wpel-link="internal">
								...
								<xsl:otherwise>
									<a href="{$itemURL}" data-wpel-link="internal">
										<xsl:value-of select="sitemap:loc"/>
									</a>
								</xsl:otherwise>
							</xsl:choose>
	...
	<div id="content-head">
		...
		<xsl:choose>
			<xsl:when test="$fileType='RSS'">
				<p>Generated by <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=proplugin&#038;utm_medium=xml-sitemap" target="_blank" rel="noreferrer noopener nofollow" data-wpel-link="external">All in One SEO Pro</a>, this is an RSS Sitemap, meant to be consumed by search engines like Google or Bing.</p>
				<p>
					You can find more information about RSS Sitemaps at <a href="https://www.sitemaps.org/" target="_blank" rel="noreferrer noopener nofollow" data-wpel-link="external">sitemaps.org</a>.				</p>
			</xsl:when>
			<xsl:otherwise>
				<p>Generated by <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=proplugin&#038;utm_medium=xml-sitemap" target="_blank" rel="noreferrer noopener nofollow" data-wpel-link="external">All in One SEO Pro</a>, this is an XML Sitemap, meant to be consumed by search engines like Google or Bing.</p>
				<p>
					You can find more information about XML Sitemaps at <a href="https://www.sitemaps.org/" target="_blank" rel="noreferrer noopener nofollow" data-wpel-link="external">sitemaps.org</a>.				</p>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on November 28, 2024 at 9:22 am			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="/" data-wpel-link="internal"><span>Home</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="/" class="button" data-wpel-link="internal">Back to Homepage</a>
					</div>
